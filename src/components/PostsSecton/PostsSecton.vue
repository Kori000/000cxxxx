  ...
  <div class="lg:mb-80 mb-0 pt-32">
    <div class=" lg:mx-36 mx-12 flex justify-center items-center flex-col  ">
      <div class="xl:w-[1148px] flex flex-col justify-between">
        ...
        <div id="main" class="lg:w-[1148px] flex flex-col justify-between items-center  ">
          ...
          duration-500">
              ...
              <!-- lg分辨率以下出现分割线 -->
              <CutLineMd v-show="index !== homeInfo.blogs.length - 1" class="block sm:hidden mt-20"></CutLineMd>
            </div>
