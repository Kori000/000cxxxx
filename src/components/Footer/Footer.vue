  ...
  <div>
    ...
    >
      ...
      >
        <div
          id="logo-box"
          class="flex justify-start items-center md:mt-7 "
        >
          <div class="m-2">
            <img src="../../assets/svg/footer-img-union.svg">
          </div>
          <img
            src="../../assets/svg/footer-img-text.svg"
            class="md:w-auto md:h-auto w-[119px] h-[12px]"
          >
        </div>
      ...
      <div
        id="middle"
        class="hidden lg:block w-[123px] h-[28px] "
      ></div>
      <div
        id="right"
        class=" text-end  sm:mt-0 mt-6 "
      >
        <div>
    ...
    <div
      id="bottom"
      class="block md:hidden font-Inter"
    >
      <p class=" font-semibold text-xs leading-[14px] my-5 text-white text-center">Portalverse Network 2022. All rights
        reserved.</p>
    </div>
  </div>
</template>
