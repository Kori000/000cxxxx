  ...
  <div class="md:mb-32 mt-12">
    <div class=" lg:mx-36 ld:mx-12 mx-0 flex justify-center xl:items-start items-center flex-col  min-h-screen ">
      ...
      >
        ...
        <!-- 描述小于1024显示 -->
        <div
          id=" hero_describe-1024 "
          class="reval-rightmove  mt-6 min-h-[94px]  max-w-xs flex py-2 items-center lg:hidden"
        >
          <h6 class="text-white text-lg font-medium leading-6 text-center">Harnessing Distributed and Underutilised
            Computing
            Powers
            to form a Computing
            Infrastructure
        ...
        >
          <a
            href="https://discord.com/invite/ppESW6FP43"
            target="_blank"
            class="flex justify-center items-center w-72 h-16 rounded-[20px] mr-2 sm:hover:text-2xl sm:hover:leading-[1.5rem]
          mb-14 md:mb-0
          btn-gradient
          transition-all
          ease-linear
          ...
          <button class="flex justify-evenly items-center w-60 h-14">
            <a
              ...
              target="_blank"
              class="sm:hover:text-xl transition-all 
          duration-300"
            >Read
              Whitepaper</a>
            <div class="">
              <a
                ...
                class="sm:hover:text-xl transition-all 
          duration-300"
              ><img src="@/assets/svg/RightArrow.svg "></a>
      ...
      <div
        id=" hero_describe "
        class="reval-rightmove z-10 mt-2 min-h-[94px] self-end max-w-lg lg:flex py-2 items-center hidden"
      >
        <span class="border-white border-r-2 h-20 lg:inline-block hidden"></span>
        <h6 class="text-white text-2xl font-semibold leading-7 pl-9 font-Inter-400 ">Harnessing Distributed and
          Underutilised
          Computing
          Powers
          to form a Computing
